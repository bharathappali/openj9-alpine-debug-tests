FROM bharathappali/openj9-jdk11-alpine-debug
...
RUN mkdir -p /home/openj9-testspace; \
    ...
    TAR_URL="https://github.com/bharathappali/openj9-alpine-debug-builds/raw/master/native-test-libs-debug.tar.gz"; \
